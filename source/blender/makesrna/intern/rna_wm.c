...
EnumPropertyItem rna_enum_event_type_items[] = {
	...
	{LEFTARROWKEY, "LEFT_ARROW", 0, "Left Arrow", "L"},
	{DOWNARROWKEY, "DOWN_ARROW", 0, "Down Arrow", "D"},
	{RIGHTARROWKEY, "RIGHT_ARROW", 0, "Right Arrow", "R"},
	{UPARROWKEY, "UP_ARROW", 0, "Up Arrow", "U"},
	...
	/* view buttons */
	{NDOF_BUTTON_TOP, "NDOF_BUTTON_TOP", 0, "NDOF Top", "NdofU"},
	{NDOF_BUTTON_BOTTOM, "NDOF_BUTTON_BOTTOM", 0, "NDOF Bottom", "NdofD"},
	{NDOF_BUTTON_LEFT, "NDOF_BUTTON_LEFT", 0, "NDOF Left", "NdofL"},
	{NDOF_BUTTON_RIGHT, "NDOF_BUTTON_RIGHT", 0, "NDOF Right", "NdofR"},
